...
public class MainClass02 {
		...
		public static void main(String[] args) {
				...
				int num1=10;
				// int type 변수 선언만 하고 (선언만하면 만들어지지 않는다.)
				int num2;
				...
				int b=myByte;
				// int type 변수의 값을 byte type 변수에 대입 (문법 오류)
				// byte c=myInt;
				
				/*
				 * 	표현 가능한 범위가 더 넓은 변수에 담긴 내용을 대입하려면
				 * 	프로그래머가 대입을 해도 문제가 없다는 것을 확인하고
				 * 	명시적으로 casting 하면 대입이 가능한다.
				 * 	( myInt 안에 있는 숫자는 byte 범위를 절대 넘어가지 않는다. )
				 */
				
				byte c=(byte)myInt;			//	강제 casting(타입) 을 하면 대입 가능
